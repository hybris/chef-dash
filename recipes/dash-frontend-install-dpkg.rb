...
# Recipe:: dash-frontend-install-dpkg
#
...
remote_file "#{Chef::Config[:file_cache_path]}/dash-frontend_#{node['chef-dash']['package']['version']}_all.deb" do
  source "#{node['dpkg']['frontend-url']}/dash-frontend_#{node['chef-dash']['package']['version']}_all.deb"
end
